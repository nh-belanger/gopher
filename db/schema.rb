...
ActiveRecord::Schema.define(version: 20170212202838) do
  ...
  create_table "reservationrequests", force: :cascade do |t|
    t.integer "member_id",      null: false
  ...
  create_table "teetimerequests", force: :cascade do |t|
    t.integer "member_id",  null: false
